...
export class InitialMigration1763824866758 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."people_eating_rate_enum" AS ENUM('low', 'normal', 'high')`);
        await queryRunner.query(`CREATE TYPE "public"."people_gender_enum" AS ENUM('male', 'female', 'other')`);
        await queryRunner.query(`CREATE TYPE "public"."people_sport_rate_enum" AS ENUM('low', 'normal', 'high')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."homes_food_type_enum" AS ENUM('process_food', 'vegetarian', 'healthy', 'balanced', 'other')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."inventory_movements_movement_type_enum" AS ENUM('in', 'out', 'adjustment')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."data_loads_source_type_enum" AS ENUM('receipt', 'manual')`);
